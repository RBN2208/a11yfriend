...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@/shared/components/shadcn-components/ui/tooltip"
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-[--sidebar-height] w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
